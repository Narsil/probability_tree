...
var manageTextarea = (function() {
  ...
  return function manageTextarea(el, opts) {
    ...
    function onKeypress(e) {
      ...
      /////////////////////////////////////////////
      // ADDITION BY KWYK - Nicolas Patry
      // /////////////////////////////////////////
      if (e.which == 94 || // (Chrome ^ FR|EN) + (FF ^ EN)
          e.which == 95 || // Chrome|FF _ FR|EN
          e.which === 0 && e.type == 'keydown' // FF ^ FR
      ){
          var cursor = $(this).mathquill('cursor');
          if (cursor[-1] === 0){
              $(this).mathquill('write', 'y');
          }
      }
      /////////////////////////////////////
